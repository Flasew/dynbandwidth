...
int main(int argc, char * argv[]) {
  ...
  ignore = system("/sbin/tc qdisc add dev macvlan0 root tbf rate 5.5Gbit burst 48750b lat 100ms");
  ignore = system("/sbin/tc qdisc add dev macvlan1 root tbf rate 5.5Gbit burst 48750b lat 100ms");
  ignore = system("/sbin/tc qdisc add dev enp1s0 root netem delay 100us limit 2000");
  ...
  struct tc_netem_qopt nopt = { .limit = 2*ql };
